...
namespace FreeCourse.Service.Discount.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        private readonly IDbConnection _dbConnection; //Farklı databaselere baglanmak istediğimizde kullanırız.
        ...
        {
            var status = await _dbConnection.ExecuteAsync("INSERT INTO discount(userid,rate,code) VALUES(@UserId,@Rate,@Code)", model);
            if (status > 0)
            {
